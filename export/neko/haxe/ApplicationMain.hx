...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("test-music", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("test-music", null, 640, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "test-music";
		app.meta["name"] = "test-music";
